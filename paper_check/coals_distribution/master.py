...
def MakeMasterCoals():
    ...
    while i < 5:
        ...
        subprocess.call(["/Applications/BEAST\ 2.6.6/bin/beast -threads 8 FinalModelDistFixed.xml"], shell = True,
                       cwd=filepath)


        newick_tree_file_from_master = '/Users/LAB-SCG-125/Documents/Master_sim/FinalModelDistFixed.newick'
        ...
        if len(coal_times_master) < 1000:
            ...
            file = open(
                "/Users/LAB-SCG-125/PycharmProjects/mutation_dependencies_2.0/paper_check/coals_distribution/" + str(
                    i) + " master", "w")
